package com.whu.order.controller.file;

import com.whu.order.commons.result.ActionResult;
import com.whu.order.commons.result.UploadFileResponse;
import com.whu.order.file.FileService;
...
@Api(tags = "文件接口")
@RestController
@RequestMapping("/onlinerestaurant/file")
@Slf4j
@Validated
