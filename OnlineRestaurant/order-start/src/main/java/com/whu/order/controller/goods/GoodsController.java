package com.whu.order.controller.goods;
...
import com.whu.order.domain.goods.dto.GoodsListDTO;
import com.whu.order.domain.goods.dto.GoodsOptionDTO;
import com.whu.order.domain.goods.dto.GoodsTypeDTO;
...
import com.whu.order.types.goods.GoodsListQuery;
import com.whu.order.domain.goods.vo.*;
...
@RestController
@Api(tags = "Goods接口")
@RequestMapping("/onlinerestaurant/app/goods")
@Validated
@Slf4j
