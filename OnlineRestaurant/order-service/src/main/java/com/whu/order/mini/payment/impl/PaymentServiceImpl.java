package com.whu.order.mini.payment.impl;

import com.whu.order.commons.utils.DateUtils;
import com.whu.order.domain.goods.dto.GoodsDTO;
...
import com.whu.order.mini.goods.service.GoodsService;
import com.whu.order.mini.order.bo.OrderFormBO;
import com.whu.order.mini.order.service.OrderService;
import com.whu.order.mini.payment.PaymentService;
import com.whu.order.redis.RedisService;
import com.whu.order.repository.dao.GoodsOptionItemDOMapper;
...
import com.whu.order.types.payment.*;
import com.whu.order.types.payment.*;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Order creatonlinerestaurant(PrePayQuery prePayQuery, Integer userId) {
        ...
        //生成订单号
        String orderNum = this.creatonlinerestaurantNum();
     ...
     * @return 订单号
     */
    private String creatonlinerestaurantNum() {
