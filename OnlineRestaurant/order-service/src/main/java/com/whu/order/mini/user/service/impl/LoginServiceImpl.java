...
import com.whu.order.domain.user.wx.WxAccessTokenResponse;
import com.whu.order.domain.user.wx.WxLoginResponse;
import com.whu.order.domain.user.wx.WxPhoneInfo;
...
import com.whu.order.types.user.UserConstant;
import com.whu.order.types.user.UserGenderEnum;
