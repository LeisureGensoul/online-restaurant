package com.whu.order.mini.goods.service.impl;

import com.whu.order.commons.result.PageResult;
import com.whu.order.mini.goods.service.GoodsService;
import com.whu.order.domain.goods.dto.*;
import com.whu.order.repository.dao.GoodsDOMapper;
import com.whu.order.repository.dao.ext.GoodsMapperExt;
import com.whu.order.repository.dao.ext.GoodsTypeDOMapperExt;
import com.whu.order.repository.dao.ext.query.GoodsListParam;
import com.whu.order.repository.entity.GoodsDO;
import com.whu.order.repository.entity.GoodsTypeDO;
import com.whu.order.repository.entity.ext.Goods;
import com.whu.order.repository.entity.ext.GoodsList;
