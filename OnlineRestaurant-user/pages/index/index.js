...
Page({
   ...
   */
  data: {
    staticUrl: "http://47.92.71.42:8080/onlinerestaurant/static",
    leftMenuList: null,
    showTastePreferenceButton:true,
    //左侧菜单的当前索引
    currentIdx: -2,
    //优惠券
    upto: 11,
  ...
  handleTastePreferenceTap() {
    wx.navigateTo({
      url: '/pages/recommend/recommend', // 假设口味偏好页面路径为 pages/recommend/recommend
    })
  },
